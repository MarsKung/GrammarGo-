# /GrammarGo_Pro/project/game_logic.py

import random

# 不再使用單一的 game_state，而是用一個 games 字典來管理所有房間的狀態
games = {}

# 其他的常數可以保留，因為它們是所有遊戲共享的
GAME_ROOM_PREFIX = 'game_room_' # SocketIO 房間的前綴
...
CHANCE_CARDS = [
    ...
    {'type': 'move_relative', 'value': 1, 'text': '撿到一塊錢，心情愉快地前進 1 格。'},
]

DESTINY_CARDS = [
    {'type': 'move_relative', 'value': -2, 'text': '踩到香蕉皮，滑退 2 格。'},
    {'type': 'move_relative', 'value': -4, 'text': '烏雲罩頂，倒退 4 格，真倒楣！'},
    {'type': 'move_absolute', 'value': 1, 'text': '時空錯亂，被傳送回起點附近！'},
...
def create_new_game_state():
    ...
    return {
        ...
        'winner': None,
        'used_sentences': set(),
        'player_sids': {} # 新增一個 mapping: sid -> player_id
    }
